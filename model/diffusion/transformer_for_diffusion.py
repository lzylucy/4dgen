...
from model.diffusion.positional_embedding import (
    SinusoidalPosEmb,
)
...
class TransformerForDiffusion(ModuleAttrMixin):
    def __init__(
        ...
        if causal_attn:
            ...
            # in the input sequence torch.nn.Transformer uses additive mask as
            # opposed to multiplicative mask in minGPT therefore, the upper
            # triangle should be -inf and others (including diag) should be 0.
            sz = T
    ...
    def forward(
        ...
        **kwargs
        ...
        if not torch.is_tensor(timesteps):
            # this requires sync between CPU and GPU. So try to pass
        ...
        if self.encoder_only:
            ...
            if self.obs_as_cond:
                ...
                cond_embeddings = torch.cat(
                    [cond_embeddings, cond_obs_emb], dim=1
                )
