...
class FinetuneSVDLightningWorkspace(BaseWorkspace):
    """
    ...
    def run(self, unit_test=False):
        ...
        trainer = Trainer(
            ...
            gradient_clip_val=self.resolved_cfg.training.get("gradient_clip_val", 1.),
            gradient_clip_algorithm=self.resolved_cfg.training.get("gradient_clip_algorithm", "norm"),
        )
