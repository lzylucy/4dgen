...
class AttentionBlock(nn.Module):
    ...
    def forward(self, x: th.Tensor, x_pos: th.Tensor=None, **kwargs) -> th.Tensor:
        return checkpoint(self._forward, x, x_pos)

    def _forward(self, x: th.Tensor, x_pos: th.Tensor) -> th.Tensor:
        b, c, *spatial = x.shape
        x = x.reshape(b, c, -1)
